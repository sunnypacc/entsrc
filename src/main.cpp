...
unsigned int nStakeMinAge = 60 * 60 * 24 * 3650;	// minimum age for coin age: 1d
unsigned int nStakeMaxAge = 60 * 60 * 24 * 365000;	// stake age of full weight: 100d
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "2016/11/2 PM 6:00 build ENTCOIN in office.";
        CTransaction txNew;
        ...
        printf("block.nNonce = %u \n", block.nNonce);
            block.print();
        assert(block.hashMerkleRoot == uint256("0x038523aab1cc575e10a113953a01cb927efba86f801e7688983e7506bc2d32ef"));
...
unsigned char pchMessageStart[4] = { 0x23, 0x35, 0x11, 0x6c };
